...
/**
 * Manages "Authentication" to WatchWeather's backend service.  The SyncAdapter framework
 ...
 */
public class WatchWeatherAuthenticator extends AbstractAccountAuthenticator {

    public WatchWeatherAuthenticator(Context context) {
        super(context);
    }
